...
const JobDescription = () => {
    ...
    const isInitiallyAppled = singleJob?.applications?.some(application => application?.applicant === user._id) || false;
    const [isApplied, setIsApplied] = useState(isInitiallyAppled);
        ...
        <div>
            ...
            <div className='max-w-7xl mx-auto my-10 p-2'>
                <div className='flex justify-between items-center'>
                    ...
                    {
                        <Button className='rounded-full bg-[#7209b7]' onClick={isApplied ? null : applyJobhandler} disabled={isApplied}>{isApplied ? 'Applied already' : 'Apply now'}</Button>
                    }
                </div>
